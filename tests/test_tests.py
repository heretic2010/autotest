...
def test_add(client):
    response = client.post(
        '/api/addnew',
        data=json.dumps({'id': '8', 'username': 'Victor Kozlov', 'email': 'kozlov@gmail.com', 'department': 'backend',
...
def test_delete(client):
    response = client.delete(
        '/api/delete/4',
        data=json.dumps({'id': '10', 'username': 'Badjaj Aqumba', 'email': 'aqumba@gmail.com', 'department': 'sales',
